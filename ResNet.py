...
class ResNetModel:
    def __init__(self, input_shape: Tuple[int, int, int], num_classes: int, num_filters: int,
        ...
        self.model_path = 'resnet_light.h5'
    ...
    def build(self) -> tf.keras.models.Model:
        ...
        x = Conv2D(self.init_filters, (7, 7), strides=2, kernel_regularizer=self.ker_reg)(inputs)
...
# a = 48
# model = ResNetModel(input_shape=(a, a, 3), num_filters=64, num_classes=67,
#                     regularization=0.0005, input_name='input', output_name='output').build()
# print(model.summary())
# model.save('resnet_light.h5')
